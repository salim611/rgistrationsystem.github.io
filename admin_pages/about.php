...
<br>
		<div id="content">
			...
			<div class="space"></div>
			<div class="center">
				<center><h1 style='color:white'>Update About page</h1></center><br>
				<center><form action='about.php' method='POST' >
					<br><br>
...
if (!$conn)
  ...
  die('Could not connect: ' . mysqli_error());
				...
				if (isset($_POST['add'])&&!empty($_POST['full'])) {
					$full=$_POST['full'];
					$query=mysqli_query($conn,"UPDATE `contents` SET `full_contents`='$full'  WHERE `id`='6'");
					if ($query) {
